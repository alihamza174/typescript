// Question 2
var mess = "Hello Eric, would you like to learn some Python today?";
console.log(mess);
// Question 3
var person = "Ali Hamza";
...
var message = ' ${famous_person} is our beloved prophet';
console.log(message);
// Question 6
var stripping_name = "                   Ali Hamza            ";
...
// Question 9
var my_num = +32376770;
console.log('My fav number ${my_num}');
// Question 11
var my_arr = ["Ali", "Tayyab", "Amir"];
for (var _i = 0, my_arr_1 = my_arr; _i < my_arr_1.length; _i++) {
    var name_1 = my_arr_1[_i];
    console.log(name_1);
}
